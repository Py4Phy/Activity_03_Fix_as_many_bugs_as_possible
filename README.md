...
yours to solve during class time. Follow the instructions in
[assignment.md](assignment.md) and submit as described below.


## NOTE: Additional packages required for testing

If you want to run all tests with `pytest` **locally** on your laptop
then install the
...
**Installation of the pytest-timeout package is NOT required for
submitting to GitHub** because it is automatically installed when the
